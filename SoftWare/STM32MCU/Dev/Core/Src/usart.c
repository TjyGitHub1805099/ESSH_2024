...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = USART1_TX_INNERSCREEN_RX_Pin|USART1_RX_INNERSCREEN_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = USART2_TX_EXTSCREEN_RX_Pin|USART2_RX_EXTSCREEN_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = MCU_UART4_TX_Pin|MCU_UART4_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, USART1_TX_INNERSCREEN_RX_Pin|USART1_RX_INNERSCREEN_TX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, USART2_TX_EXTSCREEN_RX_Pin|USART2_RX_EXTSCREEN_TX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, MCU_UART4_TX_Pin|MCU_UART4_RX_Pin);
...
{  
  ...
  else if(huart->Instance == huart4.Instance)//USART4 connected RS485
  {
