...
typedef enum
{
    ...
    E_F_HANDLE_JOBID_W_DATACENTER_CLEAR_BACKUP_DATAPAYLOAD_2025=0x11,//用户备份区数据全擦除
     ...
     //2025071
    E_F_HANDLE_JOBID_W_DATACENTER_DELETE_SINGLE_2025=0x12,//用户区单条擦除
    E_F_HANDLE_JOBID_W_DATACENTER_DELETE_SINGLE_CRC_2025=0x13,//用户区单条擦除
    E_F_HANDLE_JOBID_W_DATACENTER_DELETE_BACKUP_SINGLE_2025=0x14,//用户备份区数据单条擦除
